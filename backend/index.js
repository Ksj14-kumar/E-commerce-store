...
var accessLogStream = fs.createWriteStream(
  path.join(__dirname, "accessLogger.log"),
  { flags: "a" }
);
...
app.use(express.static("view", { extensions: ["js"] }));
...
require("./Services/Socket.connection").Socket(
  server,
...
console.log = function (d) {
  fs.createWriteStream(__dirname + "/log.log", { flags: "a" }).write(
    utl.format(d) + "\n"
  );
